...
// backdrop + gradient, with the poster, title, status, and key facts overlaid — the top
// half of the title-page hybrid. Falls back to the charcoal band when there's no banner,
// so overlaid text always reads. The catalog/info sections live below this.
  ...
  return (
    <section className="relative overflow-hidden rounded-[var(--radius-lg)] border border-hairline bg-band text-band-ink">
      ...
      <div className="relative flex flex-col gap-5 p-5 sm:p-7">
        <Link
          href={backHref}
          className="inline-flex items-center gap-1 t-body-sm text-band-ink/70 transition-colors hover:text-band-ink"
        >
